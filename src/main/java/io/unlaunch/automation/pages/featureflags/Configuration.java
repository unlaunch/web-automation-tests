...
public class Configuration {
    ...
    public void addConfiguration() {
        ...
        Browser.fluentWait((WebDriver t) -> t.findElement(By.cssSelector(".card:nth-child(1) > .card-body .btn"))).click();
        ...
        Browser.fluentWait((WebDriver t) -> t.findElement(By.cssSelector(".\\__at_btn_save"))).click();
        ...
        Browser.fluentWait((WebDriver t) -> t.findElement(By.cssSelector(".card:nth-child(2) > .card-body .btn"))).click();
        ...
        Browser.fluentWait((WebDriver t) -> t.findElement(By.className("__at_btn_add_config"))).click();

        Browser.fluentWait((WebDriver t) -> t.findElement(By.cssSelector(".card:nth-child(3) > .card-body"))).click();
        ...
        Browser.sleep(1);
        Browser.fluentWait((WebDriver t) -> t.findElement(By.cssSelector(".card:nth-child(1) > .card-body:nth-child(2) div:nth-child(2) span:nth-child(1)"))).click();
